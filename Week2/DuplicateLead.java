...
//		driver.get("https://www.facebook.com/");
		...
		edgebrowser.findElement(By.xpath("//input[@id='createLeadForm_firstNameLocal']"))
				.sendKeys("Test First Name Local");
		...
		edgebrowser.findElement(By.xpath("//input[@id='createLeadForm_primaryEmail']"))
				.sendKeys("ranjith.sekar@gmail.com");

		WebElement dropdown1 = edgebrowser
		...
		edgebrowser.findElement(By.xpath("//a[text()='Duplicate Lead']")).click();
		edgebrowser.findElement(By.xpath("//input[@id='createLeadForm_companyName']")).clear();
		edgebrowser.findElement(By.xpath("//input[@id='createLeadForm_companyName']")).sendKeys("New Company Name update");
		edgebrowser.findElement(By.xpath("//input[@id='createLeadForm_firstName']")).clear();
		edgebrowser.findElement(By.xpath("//input[@id='createLeadForm_firstName']")).sendKeys("LearningRanjith");
		edgebrowser.findElement(By.xpath("//input[@name='submitButton']")).click();
